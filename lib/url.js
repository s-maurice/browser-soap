...
export function urlParse(url, parseQueryString, slashesDenoteHost) {
...
export function urlResolve(source, relative) {
  return urlFormat(urlResolveObject(source, relative));
}
export function urlResolveObject(source, relative) {
